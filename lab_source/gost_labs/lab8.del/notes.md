...
ip netns exec ns1 gost -L http://10.0.20.1:8000 -F http://user:pass@10.0.10.1:8080


# ns2
ip netns exec ns2 iperf3 -c 10.0.10.1

ip netns exec ns2 curl -x http://10.0.20.1:8000 http://10.0.10.1
ip netns exec ns2 curl  http://10.0.10.1
